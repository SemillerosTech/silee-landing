...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.email.trim() || !formData.visitorType) {
      ...
      <div className="content-container">
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="visitorType" className="block text-sm font-medium text-primary mb-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, visitorType: e.target.value as VisitorType }))}
                  className="silee-select"
                  required
                >
                  <option value="">Selecciona una opción</option>
                  <option value="student">Estudiante — Interesado/a en formación</option>
                  <option value="direct-buyer">Comprador directo — Interesado/a en obras de Viktor Frankl</option>
                </select>
